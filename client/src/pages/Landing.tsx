...
export default function Landing() {
  ...
  return (
    <div className="landing cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      <img src={logo} alt="Eco-co Challenge" className="landing__logo center" />
      <div className="landing__container">
        ...
        <p className="landing__text">
          ...
          commodo lorem varius rutrum. Duis accumsan sapien nisl, et finibus
          nunc viverra et. Pellentesque commodo accumsan erat, vehicula tempor
          arcu cursus et. Phasellus in molestie sapien, nec aliquam dui. Ut
          pretium nulla imperdiet ligula vehicula posuere. Morbi pharetra diam
          sit amet tempor eleifend. Curabitur interdum risus a imperdiet tempus.
          Nam aliquam ante ex, efficitur bibendum diam gravida eget. Ut sed
          iaculis urna. Aenean eu mi nec elit vestibulum congue. Duis non lacus
          vitae nisi lobortis semper vel mattis ligula.
        </p>
