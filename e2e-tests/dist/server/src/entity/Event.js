...
__decorate([
    (0, type_graphql_1.Field)(() => [Action_1.default], { nullable: true }),
    (0, typeorm_1.ManyToMany)(() => Action_1.default, (action) => action.events),
    __metadata("design:type", Array)
...
__decorate([
    (0, type_graphql_1.Field)(() => [Number], { nullable: true }),
    __metadata("design:type", Array)
], EventInput.prototype, "actionsId", void 0);
